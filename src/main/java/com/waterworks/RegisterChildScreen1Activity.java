...
public class RegisterChildScreen1Activity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!isInternetPresent) {
            ...
            spinnerStudentGender.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                @Override
                public void onItemSelected(AdapterView<?> arg0, View arg1, int position, long arg3) {
                    studentGender = spinnerStudentGender.getSelectedItem().toString();
                }
            ...
            imgNext.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (firstname.isEmpty() || lastname.isEmpty()) {
                        ...
                        Toast.makeText(getApplicationContext(), "Please select birthdate", Toast.LENGTH_LONG).show();
                    } else {
                        ...
                        if (firstname.isEmpty() || lastname.isEmpty()) {
                            ...
                            Toast.makeText(getApplicationContext(), R.string.hint_select_gender, Toast.LENGTH_LONG).show();
                        } else {
                            isInternetPresent = Utility.isNetworkConnected(RegisterChildScreen1Activity.this);
                            if (!isInternetPresent) {
                                onDetectNetworkState().show();
    ...
    public void getAgeCalculationLoading() {
        ...
        String responseString = WebServicesCall.RunScript(AppConfiguration.MyAcnt_AgeCalculation, param);
        ...
        try {
            ...
            if (successAgeCalculation.toString().equals("True")) {
                ...
                for (int i = 0; i < jsonMainNode.length(); i++) {
                    ...
                    String lessonid = jsonChildNode.getString("lessonid").trim();
                    String lessonname = jsonChildNode.getString("lessonname").trim();
                    String EnableTrueFalse = jsonChildNode.getString("EnableTrueFalse").trim();
