...
public class ScoutBadgeMeritRegister2 extends Activity{

	private static String TAG = "ScoutMerit2";
...
//		setContentView(R.layout.activity_dive_and_turns_regi2);
		...
		if(isInternetPresent){
            ...
            String[] temp_name = AppConfiguration.meritBadgesStudentName.toString().split(",");
            String[] temp_id = AppConfiguration.meritBadgesStudentID.toString().split(",");
			...
			btn_dt2_continue.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
                    ...
                    if(checked_value.size() > 0) {
                        ...
                        if (strStudid.trim().length() == AppConfiguration.meritBadgesStudentID.length()) {
                            Intent i = new Intent(getApplicationContext(),ScoutBadgeMeritRegister3.class);
...
//					finish();
                        ...
                        Utility.ping(ScoutBadgeMeritRegister2.this, "Please select at least one session before going to next step.");
                    }
				}
			});
		}
...
//            Utility.ping(JuniorLifeGuardRegister2.this, currentStudentID);
			if(SwimmingBadgeMeritEventList.size() > 0){
				...
				Utility.ping(ScoutBadgeMeritRegister2.this, "No Events in this Session");
			}
	...
	private void Initialization() {
		...
		btnHome.setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(View v) {
				Intent intentCheckin = new Intent(ScoutBadgeMeritRegister2.this, DashBoardActivity.class);
...
//		tv_dives_turns_name = (TextView)findViewById(R.id.tv_dives_turns_name);
	...
	public AlertDialog onDetectNetworkState(){
		AlertDialog.Builder builder1 = new AlertDialog.Builder(ScoutBadgeMeritRegister2.this);
	...
	private class GetData extends AsyncTask<Void, Void, Void>{
		...
		protected void onPreExecute() {
			// TODO Auto-generated method stub
			super.onPreExecute();
			pd = new ProgressDialog(ScoutBadgeMeritRegister2.this);
		...
		protected Void doInBackground(Void... params) {
			...
			String responseString = WebServicesCall.RunScript(AppConfiguration.DOMAIN + AppConfiguration.Prg_Get_SwimmingMeritBadges_Step2, param);
			
			try {
                SwimmingBadgeMeritEventList.clear();
				JSONObject reader = new JSONObject(responseString);
				dataload= reader.getString("Success");
				if(dataload.toString().equalsIgnoreCase("True")){

					JSONArray jsonMainNode = reader.optJSONArray("SwimmingMeritBadges");
					for(int i = 0 ;i < jsonMainNode.length();i++)
					{
                        ...
                        SwimmingBadgeMeritEventList.add(hashmap);
					}
				}
				else{
					JSONArray jsonMainNode = reader.optJSONArray("SwimmingMeritBadges");
