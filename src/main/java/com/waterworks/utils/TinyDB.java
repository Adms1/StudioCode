...
public class TinyDB {
    ...
    public ArrayList<Data> getListObject(String key){
    	Gson gson = new Gson();
    	...
    	for(String jObjString : objStrings){
    		Data value  = gson.fromJson(jObjString,  Data.class);
    		objects.add(value);
    	}
    	return objects;
    }
    ...
    public void putListObject(String key, ArrayList<Data> objArray){
    	checkForNullKey(key);
    	Gson gson = new Gson();
