...
public class ScoutBadgeActivityRegister extends Activity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		txt_register.setVisibility(View.VISIBLE);
			...
			isInternetPresent = Utility.isNetworkConnected(ScoutBadgeActivityRegister.this);
	...
	class Get_UpcomingGirlsPrograms extends AsyncTask<Void, Void, Void>{
		...
		protected void onPreExecute() {
			// TODO Auto-generated method stub
			super.onPreExecute();
			pd = new ProgressDialog(ScoutBadgeActivityRegister.this);
		...
		protected Void doInBackground(Void... params) {
			...
			.RunScript(AppConfiguration.DOMAIN+AppConfiguration.Get_UpcomingSwimmingActivityBadgesPrograms, param);
	...
	class Get_GirlsProgramsRegistrations extends AsyncTask<Void, Void, Void>{
		...
		protected Void doInBackground(Void... params) {
			...
			String responseString = WebServicesCall
			.RunScript(AppConfiguration.DOMAIN+AppConfiguration.Get_SwimmingActivityBadgesRegistrations, param);
			try {
				JSONObject reader = new JSONObject(responseString);
				SwimCampData = reader.getString("Success");
				if(reader.toString().contains("Msg")){
