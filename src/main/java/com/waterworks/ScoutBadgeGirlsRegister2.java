...
public class ScoutBadgeGirlsRegister2 extends Activity {

    private static String TAG = "ScoutGirls2";
    Boolean isInternetPresent = false;
    Button relMenu;
    String token, familyID, stulist, dataload = "False", msg, childno;
    String siteid, currentStudentID;
    LinearLayout llTabs;
...
//    Animation animSlidInLeft = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.scoutgirlsregister2);
        ...
        if (isInternetPresent) {
            ...
            String[] temp_name = AppConfiguration.girlScoutBadgesStudentName.toString().split(",");
            String[] temp_id = AppConfiguration.girlScoutBadgesStudentID.toString().split(",");
            ...
            btn_dt2_continue.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (checked_value.size() > 0) {
                        ...
                        if (strStudid.trim().length() == AppConfiguration.girlScoutBadgesStudentID.length()) {
                            Intent i = new Intent(getApplicationContext(), ScoutBadgeGirlsRegister3.class);
...
//                            05-06-2017 megha
                            ...
                            viewOrangeBar.setBackgroundResource(R.drawable.error_border);
                            Utility.ping(ScoutBadgeGirlsRegister2.this, "Please select at least one session for each student.");

                        }
                    } else {

                        Utility.ping(ScoutBadgeGirlsRegister2.this, "Please select at least one session before going to next step.");
                    }
                }
            });
        } else {
    ...
    public void makeTabs(String studentID) {
        ...
        for (int i = 0; i < childList.size(); i++) {
            childTabs = getLayoutInflater().inflate(R.layout.layout_tabs, null, false);
            TextView txtStudentNameTabs = (TextView) childTabs.findViewById(R.id.txtStudentNameTabs);
            viewOrangeBar = (View) childTabs.findViewById(R.id.viewOrangeBar);
...
//                lv_body.setAnimation(animSlidInLeft);
    ...
    private void Initialization() {
        ...
        btnHome.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intentCheckin = new Intent(ScoutBadgeGirlsRegister2.this, DashBoardActivity.class);
...
//        animSlidInLeft = AnimationUtils.loadAnimation(this, R.anim.slide_in_right);
    ...
    public AlertDialog onDetectNetworkState() {
        AlertDialog.Builder builder1 = new AlertDialog.Builder(ScoutBadgeGirlsRegister2.this);
    ...
    private class GetData extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            // TODO Auto-generated method stub
            super.onPreExecute();
            pd = new ProgressDialog(ScoutBadgeGirlsRegister2.this);
        ...
        protected Void doInBackground(Void... params) {
            ...
            String responseString = WebServicesCall.RunScript(AppConfiguration.DOMAIN + AppConfiguration.Prg_Get_GirlScoutBadges_Step2, param);

            try {
                GirlsScoutEventList.clear();
                JSONObject reader = new JSONObject(responseString);
                dataload = reader.getString("Success");
                if (dataload.toString().equalsIgnoreCase("True")) {
                    JSONArray jsonMainNode = reader.optJSONArray("GirlScoutBadges");
                    for (int i = 0; i < jsonMainNode.length(); i++) {
                        ...
                        GirlsScoutEventList.add(hashmap);
                    }
                } else {
