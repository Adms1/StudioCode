...
public class ScoutBadgeGirlsRegister extends Activity{
	...
	public void init(){
		...
		isInternetPresent = Utility.isNetworkConnected(ScoutBadgeGirlsRegister.this);
	...
	class Get_UpcomingGirlsPrograms extends AsyncTask<Void, Void, Void>{
		...
		protected void onPreExecute() {
			// TODO Auto-generated method stub
			super.onPreExecute();
			pd = new ProgressDialog(ScoutBadgeGirlsRegister.this);
		...
		protected Void doInBackground(Void... params) {
			...
			String responseString = WebServicesCall
					.RunScript(AppConfiguration.DOMAIN+AppConfiguration.Get_UpcomingGirlsPrograms, param);
	...
	protected void onResume() {
		...
		txt_register.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				Intent i = new Intent(mContext,ScoutBadgeGirlsRegister1.class);
				startActivity(i);
				finish();
			}
		});
	...
	class Get_GirlsProgramsRegistrations extends AsyncTask<Void, Void, Void>{
		...
		protected Void doInBackground(Void... params) {
			...
			String responseString = WebServicesCall
					.RunScript(AppConfiguration.DOMAIN+AppConfiguration.Get_GirlsProgramsRegistrations, param);
			try {
				JSONObject reader = new JSONObject(responseString);
				SwimCampData = reader.getString("Success");
				if(reader.toString().contains("Msg")){
