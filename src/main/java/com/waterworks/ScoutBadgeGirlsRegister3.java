	...
	public void get_checked(){
		for (int i = 0; i < ScoutBadgeGirlsRegister2.mChecked.size(); i++) {
			if(ScoutBadgeGirlsRegister2.mChecked.get(i)){
				...
				/*FullName.add(ScoutBadgeGirlsRegister2.FullName.get(key));
				Studentid.add(ScoutBadgeGirlsRegister2.Studentid.get(key));
				tbid.add(ScoutBadgeGirlsRegister2.tbid.get(key));
				sessionname.add(ScoutBadgeGirlsRegister2.sessionname.get(key));
				startdate.add(ScoutBadgeGirlsRegister2.startdate.get(key));
				enddate.add(ScoutBadgeGirlsRegister2.enddate.get(key));
				unitprice.add(ScoutBadgeGirlsRegister2.unitprice.get(key));
				sitename.add(ScoutBadgeGirlsRegister2.sitename.get(key));*/
			}
		}
		/*lv_body.setAdapter(new Dt2BodyAdapter(ScoutBadgeGirlsRegister3.this,
		...
		public View getView(final int position, View convertView, ViewGroup parent) {
			...
			try{
				if(convertView==null){
					...
					holder.tv_name.setText(Html.fromHtml("<b>Participants:</b> "+FullName.get(position)));
					holder.tv_sess.setText(Html.fromHtml("<b>Sess#:</b> "+tbid.get(position)));
...
//                Intent i = new Intent(ScoutBadgeGirlsRegister3.this,ViewCartActivity.class);
