 ...
 */
public class StudentProgressLevelAsyncTask extends AsyncTask<Void, Void, String> {
    TokenStudentID tokenStudentID = null;
    Context mContext = null;

    public StudentProgressLevelAsyncTask(Context context, TokenStudentID tokenStudentID){
        mContext = context;
    ...
    protected String doInBackground(Void... params) {
        ...
        try {
            responseString = WebServicesCall.RunScript(AppConfiguration.GetStudentLevelProgressURL, wsParam);
        }catch (Exception e){
            e.printStackTrace();
        }
