 ...
 */
public class GetStudentTrophiesAsyncTask extends AsyncTask<Void, Void, String> {
    ProgressDialog pd;
    TokenStudentID tokenStudentID = null;
    Context mContext = null;

    public GetStudentTrophiesAsyncTask(Context context, TokenStudentID tokenStudentID){
        mContext = context;
    ...
    protected String doInBackground(Void... params) {
        ...
        try {
            responseString = WebServicesCall.RunScript(AppConfiguration.DOMAIN + AppConfiguration.GetStudentTrophiesURL, wsParam);
