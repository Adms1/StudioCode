 ...
 */
public class GetEventNameAsyncTask extends AsyncTask<Void, Void, String> {
    ProgressDialog pd;
    TokenStudentID tokenStudentID = null;
    Context mContext = null;

    public GetEventNameAsyncTask(Context context, TokenStudentID tokenStudentID){
        mContext = context;
    ...
    protected String doInBackground(Void... params) {
        ...
        try {
            responseString = WebServicesCall.RunScript(AppConfiguration.DOMAIN + AppConfiguration.GetStudentEventsURL, wsParam);
            Log.e("Trophy Room : GetStudentEventsURL", responseString);
        }catch (Exception e){
            e.printStackTrace();
        }
