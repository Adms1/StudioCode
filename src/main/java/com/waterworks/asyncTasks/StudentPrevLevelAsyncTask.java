 ...
 */
public class StudentPrevLevelAsyncTask extends AsyncTask<Void, Void, String> {
    TokenStudentID tokenStudentID = null;
    Context mContext = null;

    public StudentPrevLevelAsyncTask(Context context, TokenStudentID tokenStudentID){
        mContext = context;
    ...
    protected String doInBackground(Void... params) {
        ...
        try {
            responseString = WebServicesCall.RunScript(AppConfiguration.DOMAIN + AppConfiguration.GetStudentPreviousLevelprereqURL, wsParam);
        }catch (Exception e){
            e.printStackTrace();
        }
