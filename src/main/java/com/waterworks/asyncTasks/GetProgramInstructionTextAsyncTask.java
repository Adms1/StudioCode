...
public class GetProgramInstructionTextAsyncTask extends AsyncTask<Void, Void, String> {

    String programID;

    public GetProgramInstructionTextAsyncTask(String programID) {
    ...
    protected String doInBackground(Void... params){
        ...
        String responseString = WebServicesCall.RunScript(AppConfiguration.DOMAIN + AppConfiguration.Get_ProgramsInstructions, param);
