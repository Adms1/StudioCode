...
public class ScoutBadgeActivityRegister2 extends Activity {

    private static String TAG = "ScoutActivity2";
...
//		setContentView(R.layout.activity_dive_and_turns_regi2);
        ...
        isInternetPresent = Utility.isNetworkConnected(ScoutBadgeActivityRegister2.this);
        ...
        if (isInternetPresent) {
            ...
            String[] temp_name = AppConfiguration.activityBadgesStudentName.toString().split(",");
            String[] temp_id = AppConfiguration.activityBadgesStudentID.toString().split(",");
            ...
            btn_dt2_continue.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (checked_value.size() > 0) {
                        ...
                        if (strStudid.trim().length() == AppConfiguration.activityBadgesStudentID.length()) {
                            Intent i = new Intent(getApplicationContext(), ScoutBadgeActivityRegister3.class);
...
//					finish();
                        ...
                        Utility.ping(ScoutBadgeActivityRegister2.this, "Please select at least one session before going to next step.");
                    }
                }
            });
        } else {
...
//            Utility.ping(JuniorLifeGuardRegister2.this, currentStudentID);
            if(SwimmingBadgeActivityEventList.size() > 0){
                ...
                Utility.ping(ScoutBadgeActivityRegister2.this, "No Events in this Session");
            }
    ...
    private void Initialization() {
        ...
        btnHome.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intentCheckin = new Intent(ScoutBadgeActivityRegister2.this, DashBoardActivity.class);
...
//        tv_dives_turns_name = (TextView) findViewById(R.id.tv_dives_turns_name);
    ...
    protected void onResume() {
        ...
        isInternetPresent = Utility
                .isNetworkConnected(ScoutBadgeActivityRegister2.this);
    }
    ...
    public AlertDialog onDetectNetworkState() {
        AlertDialog.Builder builder1 = new AlertDialog.Builder(ScoutBadgeActivityRegister2.this);
    ...
    private class GetData extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            // TODO Auto-generated method stub
            super.onPreExecute();
            pd = new ProgressDialog(ScoutBadgeActivityRegister2.this);
...
//            String basketID = (AppConfiguration.BasketID.equals("BasketID")) ? "0" : AppConfiguration.BasketID;
            ...
            String responseString = WebServicesCall
                    .RunScript(AppConfiguration.DOMAIN + AppConfiguration.Prg_Get_SwimmingActivityBadges_Step2, param);

            try {
                SwimmingBadgeActivityEventList.clear();
                JSONObject reader = new JSONObject(responseString);
                dataload = reader.getString("Success");
                if (dataload.toString().equalsIgnoreCase("True")) {
                    JSONArray jsonMainNode = reader.optJSONArray("SwimmingActivityBadges");
                    for (int i = 0; i < jsonMainNode.length(); i++) {
                        ...
                        SwimmingBadgeActivityEventList.add(hashmap);
                    }
                } else {
