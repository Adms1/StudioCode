...
public class WaterPolo extends Activity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.waterpolo);
	...
	public void init(){
		...
		isInternetPresent = Utility.isNetworkConnected(WaterPolo.this);
		if (!isInternetPresent) {
			onDetectNetworkState().show();
		} else {
			new GetUpcomingWater().execute();
		}
	}
	...
	protected void onResume() {
		...
		guard_register.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				Intent i = new Intent(mContext,WaterPoloRegister1.class);
				startActivity(i);
			}
		});
	}
	class GetUpcomingWater extends AsyncTask<Void, Void, Void>{
		ProgressDialog pd;
		...
		protected void onPreExecute() {
			// TODO Auto-generated method stub
			super.onPreExecute();
			pd = new ProgressDialog(WaterPolo.this);
		...
		protected Void doInBackground(Void... params) {
			...
			.RunScript(AppConfiguration.DOMAIN+AppConfiguration.Get_Upcomingwaterpolo, param);
			try {
	...
	private class GetWaterRegister extends AsyncTask<Void, Void, Void>{
		ProgressDialog pd;
		...
		protected Void doInBackground(Void... params) {
			...
			String responseString = WebServicesCall
			.RunScript(AppConfiguration.DOMAIN+AppConfiguration.Get_WaterpoloConditioningRegistrations, param);
			try {
				JSONObject reader = new JSONObject(responseString);
				SwimCampData = reader.getString("Success");
				if (SwimCampData.toString().equals("True")) {
