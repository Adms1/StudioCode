...
public class ScoutBadgeActivityRegister1 extends Activity{

	private static String TAG = "ScoutActivity1";
	Button relMenu;
	...
	ScrollView scrollviewactivitybadge;

	@Override
	protected void onCreate(Bundle savedInstanceState) {
		// TODO Auto-generated method stub
		super.onCreate(savedInstanceState);
		setContentView(R.layout.scoutactivityregister1);
        ...
        pd = new ProgressDialog(ScoutBadgeActivityRegister1.this);
        pd.setMessage("Please wait...");
        pd.setCancelable(false);
		isInternetPresent = Utility.isNetworkConnected(ScoutBadgeActivityRegister1.this);
	...
	private void Initialization() {
		...
		btnHome.setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(View v) {
				Intent intentCheckin = new Intent(ScoutBadgeActivityRegister1.this, DashBoardActivity.class);
				intentCheckin.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK | Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_NEW_TASK);
				startActivity(intentCheckin);
				finish();
			}
		});
		scrollviewactivitybadge=(ScrollView)findViewById(R.id.scrollviewactivitybadge);
		...
		tv_fsn_info.setText(Utility.getProgramsInstructionText("8"));
		...
		scrollviewactivitybadge.setOnTouchListener(new View.OnTouchListener() {
			@Override
	...
	private class GetSite extends AsyncTask<Void, Void, Void>{
		...
		protected Void doInBackground(Void... params) {
			...
			String responseString = WebServicesCall.RunScript(AppConfiguration.DOMAIN + AppConfiguration.Get_ActivityBadgesSiteList, param);
		...
		protected void onPostExecute(Void result) {
			...
			if(data_load_site.toString().equalsIgnoreCase("True")){
				...
				lpw_site.setOnItemClickListener(
						new OnItemClickListener() {
							...
							public void onItemClick(AdapterView<?> parent, View view,
                                ...
                                String textPrice = Utility.getProgramsPricingText("8", siteID);
				...
				Toast.makeText(ScoutBadgeActivityRegister1.this, "Some internaml error,Please try after sometime.", Toast.LENGTH_LONG).show();
			}
		}
	}
...
//			table_dt_childs.removeAllViews();
		...
		protected Void doInBackground(Void... params) {
			...
			param.put("ProgName","Aquanaut/Swimming Activity Badges");
    ...
    public void loadDataList(ArrayList<HashMap<String, String>> list){
        ...
        try{
            for(int i = 0;i < list.size();i++) {
                View convertView = LayoutInflater.from(ScoutBadgeActivityRegister1.this).inflate(R.layout.list_row_swim_camp_register1, null);
    ...
    public AlertDialog onDetectNetworkState(){
        AlertDialog.Builder builder1 = new AlertDialog.Builder(ScoutBadgeActivityRegister1.this);
