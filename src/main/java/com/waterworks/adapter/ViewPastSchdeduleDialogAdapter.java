...
public class ViewPastSchdeduleDialogAdapter extends BaseAdapter {
	...
	ArrayList<String> Date, Day, Time, Student, Age, Level, Instructor,
			...
			NewTime, Header, Footer;

	public ViewPastSchdeduleDialogAdapter(Context context,
			...
			ArrayList<String> newtime, ArrayList<String> header,
	...
	public class ViewHolder {
		// TextView tv_header,tv_footer;
		TextView tv_student, tv_age, tv_inst, tv_lt, tv_comments, tv_level,
				tv_att, tv_location, tv_count, tv_day,tv_vs_att_for_cancel_item;
		// LinearLayout ll_vs_header,ll_vs_footer;
		...
		try {
			if (convertView == null) {
				...
				convertView = LayoutInflater.from(parent.getContext()).inflate(
						R.layout.view_past_schedule_item, null);
