...
public class SwimcompititionRegisterStep4_list4_Activity extends Activity {

    String message, DateValue, eventdates, time;
    TextView txtCompititionVal;
    String TAG = "SwimcompititionRegisterStep4_list4_Activity";
    ...
    String firstname, secondname, thirdname, firstid, thirdid, secondid, Finalid,MeetDate_Display;
...
//            Toast.makeText(getApplicationContext(), "DateValue" + DateValue, Toast.LENGTH_LONG).show();
           ...
           /* txtSelectedStudent = (TextView) findViewById(R.id.txtSelectedStudent);
            ...
            relMenu.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    //  ClearArray();
                    Intent i = new Intent(SwimcompititionRegisterStep4_list4_Activity.this, com.waterworks.SwimcompititionRegisterStep3Activity.class);
           ...
           /*         select_1.setVisibility(View.GONE);
               ...
               /* name_3.setTextColor(getResources().getColor(R.color.design_change_d2));
                ...
                name_5.setTextColor(getResources().getColor(R.color.design_change_d2));*/
                    ...
                    Intent i = new Intent(getApplicationContext(), SwimcompititionRegisterStep4_listActivity.class);
                    i.putExtra("datevalue", DateValue);
                    i.putExtra("time", time);
                    i.putExtra("eventdates", eventdates);
                    i.putExtra("MeetDate_Display", MeetDate_Display);
        ...
        try {
            ...
            StudentName = SwimcompititionRegisterStep3_list3_Activity.t_sname;
            Log.d("StudentName"+TAG, StudentName.toString());
            StudentId = new ArrayList<String>();
            StudentId = SwimcompititionRegisterStep3_list3_Activity.t_sid;
...
//                            Log.d("rg2", AppConfiguration.step3_rg2);
                            ...
                            Intent i = new Intent(SwimcompititionRegisterStep4_list4_Activity.this,
...
//                        Log.d("rg2", AppConfiguration.step3_rg2);
    ...
    public void onBackPressed() {
        // TODO Auto-generated method stub
//		super.onBackPressed();
        Intent i=new Intent(SwimcompititionRegisterStep4_list4_Activity.this,SwimcompititionRegisterStep3_list3_Activity.class);
        i.putExtra("datevalue", DateValue);
        i.putExtra("time", time);
        i.putExtra("eventdates", eventdates);
        i.putExtra("MeetDate_Display", MeetDate_Display);
