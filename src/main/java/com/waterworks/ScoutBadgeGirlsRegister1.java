...
public class ScoutBadgeGirlsRegister1 extends Activity {

    private static String TAG = "ScoutGirls1";
    Button relMenu;
    ...
    ScrollView scrollviewsgirlcout;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        // TODO Auto-generated method stub
        super.onCreate(savedInstanceState);
        setContentView(R.layout.scoutgirlsregister1);
        ...
        isInternetPresent = Utility.isNetworkConnected(ScoutBadgeGirlsRegister1.this);
    ...
    public AlertDialog onDetectNetworkState() {
        AlertDialog.Builder builder1 = new AlertDialog.Builder(ScoutBadgeGirlsRegister1.this);
            ...
            public void onClick(View v) {
                ...
                if (!btn_site.getText().toString().equalsIgnoreCase("Select site")) {
                    if (sendingID.size() > 0) {
                        ...
                        AppConfiguration.girlScoutBadgesStudentID = sendingID.toString().replaceAll("\\[", "").replaceAll("\\]", "");
                        AppConfiguration.girlScoutBadgesStudentName = studentNAME.toString().replaceAll("\\[", "").replaceAll("\\]", "");

                        Intent i = new Intent(getApplicationContext(), ScoutBadgeGirlsRegister2.class);
    ...
    private void Initialization() {
        ...
        scrollviewsgirlcout=(ScrollView)findViewById(R.id.scrollviewscoutgirl);

        tv_fsn_info.setVerticalScrollBarEnabled(true);
        tv_fsn_info.setMovementMethod(new ScrollingMovementMethod());
        scrollviewsgirlcout.setOnTouchListener(new View.OnTouchListener() {
            @Override
        ...
        btnHome.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intentCheckin = new Intent(ScoutBadgeGirlsRegister1.this, DashBoardActivity.class);
    ...
    public class GetBasketID extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            // TODO Auto-generated method stub
            super.onPreExecute();
            pd = new ProgressDialog(ScoutBadgeGirlsRegister1.this);
    ...
    private class GetSite extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            ...
            String responseString = WebServicesCall
                    .RunScript(AppConfiguration.DOMAIN + AppConfiguration.Get_GirlsScoutSiteList, param);
        ...
        protected void onPostExecute(Void result) {
            ...
            if (data_load_site.toString().equalsIgnoreCase("True")) {
                ...
                lpw_site.setOnItemClickListener(
                        new OnItemClickListener() {
                            ...
                            public void onItemClick(AdapterView<?> parent, View view,
                                ...
                                String textPrice = Utility.getProgramsPricingText("10", siteID);
                ...
                Toast.makeText(ScoutBadgeGirlsRegister1.this, "Some internaml error,Please try after sometime.", Toast.LENGTH_LONG).show();
            }
        }
    }
    ...
    public void loadDataList(ArrayList<HashMap<String, String>> list) {
        ...
        try {
            for (int i = 0; i < list.size(); i++) {
                View convertView = LayoutInflater.from(ScoutBadgeGirlsRegister1.this).inflate(R.layout.list_row_swim_camp_register1, null);
